...
public class Order_details extends AppCompatActivity {
    TextView usertv,timetv,goodtypetv,weighttv,heighttv,lengthtv,widthtv,locationtv,toLocationtv;
    ImageView imageView;
    Button callBtn;
    String location;
    String toLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1=new Intent(getApplicationContext(),Estimate.class);
                intent1.putExtra("location",location);
                intent1.putExtra("to location",toLocation);
