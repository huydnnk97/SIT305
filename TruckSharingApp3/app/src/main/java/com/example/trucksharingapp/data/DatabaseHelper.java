...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String CREATE_USER_TABLE_TWO= "CREATE TABLE " + Util.TABLE_NAME2 + "(" +Util.ORDER_ID+ " INTEGER PRIMARY KEY AUTOINCREMENT , "
                ...
                + " TEXT,"+Util.LENGTH+ " TEXT,"+Util.WIDTH+ " TEXT,"+Util.VEHICLE+ " TEXT,"+Util.TOLOCATION+" TEXT,"+Util.USERNAME+" TEXT,"
...
//        sqLiteDatabase.execSQL(DROP_USER_TABLE, new String[]{Util.TABLE_NAME});
    ...
    public long insertOrder(Order order){
        ...
        contentValues.put(Util.TOLOCATION,order.getTolocation());
...
//        db.close();
    ...
    public List<Order>fetchAllOrder(String username){
        ...
        if (cursor.moveToFirst()) {
            do {
                if(cursor.getString(11).equals(username)){
                    ...
                    order.setTolocation(cursor.getString(10));
