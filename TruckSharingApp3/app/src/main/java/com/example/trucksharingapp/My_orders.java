...
//
        ...
        add_order.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentadd=new Intent(getApplicationContext(),Check.class);
    ...
    public void onItemClick(int id) {
        ...
        intent.putExtra("location",orderList.get(id).getLocation());
        intent.putExtra("to location",orderList.get(id).getTolocation());
        startActivity(intent);
    }
}